  ...
  return (
    <div className="fixed bottom-[4.5rem] right-3 z-50 opacity-0 animate-fade-in-right animate-delay-100">
      <Button
        onClick={handleClick}
        size="sm"
        className={`rounded-full w-11 h-11 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 bg-[#0088cc] hover:bg-[#0077b5] p-0 ${className}`}
