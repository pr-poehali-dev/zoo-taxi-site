...
const TelegramButton: React.FC<TelegramButtonProps> = ({ 
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 opacity-0 animate-fade-in-right animate-delay-100">
      <Button
        onClick={handleClick}
        className={`rounded-full w-12 h-12 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 bg-[#0088cc] hover:bg-[#0077b5] ${className}`}
