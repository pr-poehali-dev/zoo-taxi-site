    ...
    <section id="reviews" className="py-12 md:py-16 bg-gray-50">
      <div className="container mx-auto">
              ...
              {reviewsLoading ? (
                ...
                reviews.map((review) => (
                  <div key={review.id} className="w-full flex-shrink-0">
                    <Card className="mx-auto max-w-2xl bg-white/50 backdrop-blur-sm border-white/60 shadow-2xl">
        ...
        <div className="mt-12 md:mt-16">
          <Card className="border-2 border-primary/20 bg-white/50 backdrop-blur-sm border-white/60 shadow-2xl">
